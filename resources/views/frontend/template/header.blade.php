...
<div class='container container_fix'>
    <div class='row row-noGutter'>
        <div class='col-lg-2 col-lg-fix2'>
            <div class='topheader_mobi hidden-lg'>
                ...
                <div class='searchion'>
                    ...
                    <div class='searchmini1'>
                        <form action='https://template-nula-cosmcleticok.blogspot.com/search'
                              class='input-group search-bar' method='get' role='search'>
                            <input autocomplete='off'
                                   class='button_gradient input-group-field auto-search visible_index' name='query'
                                   placeholder='Tìm kiếm...' required='' type='text' value=''/>
            ...
            <div class='header_left_fixwidth'>
                <div class='inner'>
                    <div class='wrap_header a-center'>
                        <div class='section' id='id-lgdt' name='Logo Desktop'>
                        ...
                        <div class='header_bottom'>
                            ...
                            <div class='social'>
                                <div class='section' id='idsocial' name='social'>
