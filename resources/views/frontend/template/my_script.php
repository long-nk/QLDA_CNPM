...
<script>
    //<![CDATA[
    !function(e,a,n,t){e.fn.doubleTapToGo=function(t){return!!("ontouchstart"in a||navigator.msMaxTouchPoints||navigator.userAgent.toLowerCase().match(/windows phone os 7/i))&&(this.each(function(){var a=!1;e(this).on("click",function(n){var t=e(this);t[0]!=a[0]&&(n.preventDefault(),a=t)}),e(n).on("click touchstart MSPointerDown",function(n){for(var t=!0,r=e(n.target).parents(),o=0;o<r.length;o++)r[o]==a[0]&&(t=!1);t&&(a=!1)})}),this)}}(jQuery,window,document),function(e){e.fn.appear=function(a,n){var t=e.extend({data:void 0,one:!0,accX:0,accY:0},n);return this.each(function(){var n=e(this);if(n.appeared=!1,a){var r=e(window),o=function(){if(n.is(":visible")){var e=r.scrollLeft(),a=r.scrollTop(),o=n.offset(),i=o.left,p=o.top,c=t.accX,s=t.accY,f=n.height(),u=r.height(),h=n.width(),l=r.width();p+f+s>=a&&p<=a+u+s&&i+h+c>=e&&i<=e+l+c?n.appeared||n.trigger("appear",t.data):n.appeared=!1}else n.appeared=!1},i=function(){if(n.appeared=!0,t.one){r.unbind("scroll",o);var i=e.inArray(o,e.fn.appear.checks);i>=0&&e.fn.appear.checks.splice(i,1)}a.apply(this,arguments)};t.one?n.one("appear",t.data,i):n.bind("appear",t.data,i),r.scroll(o),e.fn.appear.checks.push(o),o()}else n.trigger("appear",t.data)})},e.extend(e.fn.appear,{checks:[],timeout:null,checkAll:function(){var a=e.fn.appear.checks.length;if(a>0)for(;a--;)e.fn.appear.checks[a]()},run:function(){e.fn.appear.timeout&&clearTimeout(e.fn.appear.timeout),e.fn.appear.timeout=setTimeout(e.fn.appear.checkAll,20)}}),e.each(["append","prepend","after","before","attr","removeAttr","addClass","removeClass","toggleClass","remove","css","show","hide"],function(a,n){var t=e.fn[n];t&&(e.fn[n]=function(){var a=t.apply(this,arguments);return e.fn.appear.run(),a})})}(jQuery);
    //]]>
</script>
<script src='/resouce/temp/cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.4/owl.carousel.min.js'></script>
<script async='async' src='/resouce/temp/cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js'></script>
<script>
    //<![CDATA[
    ...
    window.awe = window.awe || {}, awe.init = function() {
        ...
        "use strict";
        awe_backtotop(), awe_category(), awe_lazyloadImage(), awe_tab(), awe_owl(), e(".filter-content .aside-item .aside-title").click(function(t) {
            e(this).parent().hasClass("active") ? e(".filter-content .aside-item").removeClass("active") : (e(".filter-content .aside-item").removeClass("active"), e(this).parent().addClass("active"))
        }), e(".searchion").click(function(t) {
            e(".searchmini1").hasClass("show"), e(".searchmini1").removeClass("show")
        })
    }), $(".image_thumb").hover(function() {
        $(this).each(function() {
            $(this).find("img").length > 1 && awe_lazyloadImage()
        })
    }), $(document).on("click", function(e) {
        $(e.target).closest("aside.aside-item.collection-category").length || $("aside.aside-item.collection-category").removeClass("active"), $(e.target).closest(".filter-content .aside-item").length || $(".filter-content .aside-item").removeClass("active")
    ...
    function awe_category() {
        $(".nav-category .fa-angle-down").click(function(e) {
            $(this).toggleClass("fa-angle-up fa-angle-down"), $(this).parent().toggleClass("active")
        }), $(".nav-category .fa-plus").click(function(e) {
            $(this).toggleClass("fa-minus fa-plus"), $(this).parent().toggleClass("active")
        }), $(".nav-category .fa-minus").click(function(e) {
            $(this).toggleClass("fa-plus"), $(this).parent().toggleClass("active")
        })
    }

    function awe_owl() {
        $(".owl-carousel:not(.not-owl)").each(function() {
            var e = $(this).attr("data-xs-items"),
                t = $(this).attr("data-md-items"),
                a = $(this).attr("data-lg-items"),
                o = $(this).attr("data-sm-items"),
                i = $(this).attr("data-margin"),
                n = $(this).attr("data-dot"),
                s = $(this).attr("data-nav"),
                l = ($(this).attr("data-height"), $(this).attr("data-play"));
            $(this).attr("data-loop");
            void 0 !== i && !1 !== i || (i = 30), void 0 !== e && !1 !== e || (e = 1), void 0 !== o && !1 !== o || (o = 3), void 0 !== t && !1 !== t || (t = 3), void 0 !== a && !1 !== a || (a = 3), n = void 0 !== n && !0 !== n, $(this).owlCarousel({
                loop: !1,
                margin: Number(i),
                responsiveClass: !0,
                dots: n,
    ...
    function awe_tab() {
        $(".e-tabs:not(.not-dqtab)").each(function() {
            $(this).find(".tabs-title li:first-child").addClass("current"), $(this).find(".tab-content").first().addClass("current"), $(this).find(".tabs-title li").click(function(e) {
    ...
    wDWs < 1199 && ($(".ul_menu li:has(ul)").doubleTapToGo(), $(".item_big li:has(ul)").doubleTapToGo(), $(".quickview-product").remove()), window.awe_category = awe_category, window.awe_owl = awe_owl, $(document).ready(function() {
        ...
        var t = parseInt($("input[data-field=" + fieldName + "]").val());
        isNaN(t) ? $("input[data-field=" + fieldName + "]").val(0) : $("input[data-field=" + fieldName + "]").val(t + 1)
    }), $(document).on("click", ".qtyminus", function(e) {
        e.preventDefault(), fieldName = $(this).attr("data-field");
        var t = parseInt($("input[data-field=" + fieldName + "]").val());
        !isNaN(t) && t > 1 ? $("input[data-field=" + fieldName + "]").val(t - 1) : $("input[data-field=" + fieldName + "]").val(1)
    }), $(".open-filters").click(function(e) {
        e.stopPropagation(), $(this).toggleClass("openf"), $(".dqdt-sidebar").toggleClass("openf")
    }), $(".menubar_pc").click(function() {
        $(".wrapmenu_full").slideToggle("fast"), $(".wrapmenu_full, .cloed").toggleClass("open_menu"), $(".dqdt-sidebar, .open-filters").removeClass("openf")
    }), $(".cloed").click(function() {
        $(this).toggleClass("open_menu"), $(".wrapmenu_full").slideToggle("fast")
    }), $(".opacity_menu").click(function() {
        $(".opacity_menu").removeClass("open_opacity")
    }), $(".dqdt-sidebar").hasClass("openf") && $(".wrapmenu_full").removeClass("open_menu"), $(".ul_collections li > .fa").click(function() {
        $(this).parent().toggleClass("current"), $(this).toggleClass("fa-plus fa-minus"), $(this).next("ul").slideToggle("fast"), $(this).next("div").slideToggle("fast")
    }), $(".open-menu-header").click(function(e) {
        e.stopPropagation(), $(".header_left_fixwidth").toggleClass("open_sidebar_menu"), $(".opacity_menu").toggleClass("open_opacity")
    }), $(".opacity_menu").click(function(e) {
        $(".open-menu-header").removeClass("open_button"), $(".header_left_fixwidth").removeClass("open_sidebar_menu"), $(".opacity_menu").removeClass("open_opacity")
    }), $(".quenmk").on("click", function() {
        $(".h_recover").slideToggle()
    }), $('a[data-toggle="collapse"]').click(function(e) {
        $(window).width() >= 767 && (e.preventDefault(), e.stopPropagation())
    }), $(".wrapmenu_full ul li > .fa").click(function() {
        $(this).parent().toggleClass("current"), $(this).toggleClass("fa-angle-down fa-angle-up"), $(this).next("ul").slideToggle("fast"), $(this).next("div").slideToggle("fast")
    });
    //]]>
</script>
<script>
    ...
    loadCSS("/resouce/temp/use.fontawesome.com/releases/v5.7.2/css/all.css");

    // menu

    $("#idthanhmenu").each(function() {
        for (var e = $(this).find(".LinkList ul > li").children("a"), a = e.length, n = 0; n < a; n++) {
            var t = e.eq(n),
                i = t.text();
            if ("_" !== i.charAt(0) && "_" === e.eq(n + 1).text().charAt(0)) {
                var r = t.parent();
                r.append('<i class="fa fa-angle-down"></i>');
                r.append('<ul class="level0" style = "display:none"/>')
            }
            "_" === i.charAt(0) && (t.text(i.replace("_", "")), t.parent().appendTo(r.children(".level0")))
        }
        $("#idthanhmenu ul li ul li").removeClass('level0 level-top parent');
        $("#idthanhmenu ul li ul li").addClass('level1');

    });

    $('.wrapmenu_full ul li > i.fa').click(function(){
    ...
    window.addEventListener('load', function () {
        ...
        $('#contact_us').contactUs({
            ...
            items: [
                ...
                {
                    title: 'Zalo chat',
                    subTitle: 'Tài khoản zalo: 0971539681',
...
<script type='text/javascript'>
    ...
    _WidgetManager._RegisterWidget('_ImageView', new _WidgetInfo('Image1', 'idbannersidebar', document.getElementById('Image1'), {'resize': false}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_LinkListView', new _WidgetInfo('LinkList7', 'idsocial', document.getElementById('LinkList7'), {}, 'displayModeFull'));
    ...
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML2', 'idbaner1', document.getElementById('HTML2'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML3', 'idbaner2', document.getElementById('HTML3'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML1', 'idsanphammoi', document.getElementById('HTML1'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_ImageView', new _WidgetInfo('Image2', 'idbnngang', document.getElementById('Image2'), {'resize': false}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML15', 'id-sanpham-a', document.getElementById('HTML15'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML4', 'idbanchay', document.getElementById('HTML4'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML5', 'idtintuc', document.getElementById('HTML5'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_BlogView', new _WidgetInfo('Blog1', 'content', document.getElementById('Blog1'), {'cmtInteractionsEnabled': false}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_ImageView', new _WidgetInfo('Image3', 'idlogofooter', document.getElementById('Image3'), {'resize': false}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_LinkListView', new _WidgetInfo('LinkList2', 'idvechungtoi', document.getElementById('LinkList2'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_LinkListView', new _WidgetInfo('LinkList3', 'idthongtin', document.getElementById('LinkList3'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_LinkListView', new _WidgetInfo('LinkList4', 'idthotro', document.getElementById('LinkList4'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_LinkListView', new _WidgetInfo('LinkList5', 'idlienhe', document.getElementById('LinkList5'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML7', 'idbanquyen', document.getElementById('HTML7'), {}, 'displayModeFull'));
    _WidgetManager._RegisterWidget('_HTMLView', new _WidgetInfo('HTML8', 'idcungcapboi', document.getElementById('HTML8'), {}, 'displayModeFull'));
</script>
