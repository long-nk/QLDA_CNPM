...
@section('title', 'Cập nhật đơn hàng ' . ' | Dashboard')
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left"
                                  action="{{route('checkouts.update', $data->id)}}" enctype="multipart/form-data"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <select name="status" id="status" class="form-control"
                                                required>
                                            <option value="1" {{$data->Tst_status == 1 ? "selected" : ""}}>Đã xứ lí</option>
                                            <option value="0" {{$data->Tst_status == 0 ? "selected" : ""}}>Chưa xử lí</option>
                                        </select>
                                    </div>
                                </div>
