...
@section('title', 'Thông tin profile | Dashboard')
@section('content')
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="{{url('admin/updateProfile')}}" autocomplete="off" method="post">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" value="{{Auth::user()->name}}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
